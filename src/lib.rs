...
pub mod tiles {
    ...
    static mahjong_tiles: [mahjong_tile; 34] = [
        { 0, "East Wind",  '\u{1F000}', 'z' , '1', 0x31},
        { 1, "South Wind", '\u{1F001}', 'z', '2' , 0x41},
        { 2, "West Wind", '\u{1F002}', 'z', '3', 0x51},
        { 3, "North Wind", '\u{1F003}', 'z', '4', 0x61},
        { 4, "Red Dragon", '\u{1F004}', 'z', '5', 0x71},
        { 5, "Green Dragon", '\u{1F005}', 'z', '6', 0x81},
        { 6, "White Dragon", '\u{1F006}', 'z', '7', 0x91},
                // Man 1-9 (7-15)
        { 7, "1m", '\u{1F007}', 'm', '1', 0x01},
        { 8, "2m", '\u{1F008}', 'm', '2', 0x02},
        { 9, "3m", '\u{1F009}', 'm', '3', 0x03},
        { 10, "4m", '\u{1F00A}', 'm', '4', 0x04},
        { 11, "5m", '\u{1F00B}', 'm', '5', 0x05},
        { 12, "6m", '\u{1F00C}', 'm', '6', 0x06},
        { 13, "7m", '\u{1F00D}', 'm', '7', 0x07},
        { 14, "8m", '\u{1F00E}', 'm', '8', 0x08},
        { 15, "9m", '\u{1F00F}', 'm', '9', 0x09},
                // Sou 1-9 (16-24)
        { 16, "1s", '\u{1F010}', 's', '1', 0x21},
        { 17, "2s", '\u{1F011}', 's', '2', 0x22},
        { 18, "3s", '\u{1F012}', 's', '3', 0x23},
        { 19, "4s", '\u{1F013}', 's', '4', 0x24},
        { 20, "5s", '\u{1F014}', 's', '5', 0x25},
        { 21, "6s", '\u{1F015}', 's', '6', 0x26},
        { 22, "7s", '\u{1F016}', 's', '7', 0x27},
        { 23, "8s", '\u{1F017}', 's', '8', 0x28},
        { 24, "9s", '\u{1F018}', 's', '9', 0x29},
                // Pin 1-9 (25-33)
        { 25, "1p", '\u{1F019}', 'p', '1', 0x11},
        { 26, "2p", '\u{1F01A}', 'p', '2', 0x12},
        { 27, "3p", '\u{1F01B}', 'p', '3', 0x13},
        { 28, "4p", '\u{1F01C}', 'p', '4', 0x14},
        { 29, "5p", '\u{1F01D}', 'p', '5', 0x15},
        { 30, "6p", '\u{1F01E}', 'p', '6', 0x16},
        { 31, "7p", '\u{1F01F}', 'p', '7', 0x17},
        { 32, "8p", '\u{1F020}', 'p', '8', 0x18},
        { 33, "9p", '\u{1F021}', 'p', '9', 0x19},
    ];
